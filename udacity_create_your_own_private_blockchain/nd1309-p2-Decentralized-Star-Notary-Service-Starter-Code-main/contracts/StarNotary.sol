...
contract StarNotary is ERC721 {
    ...
    string public name = "NewIdeaToken";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "Cannot exchange stars, message sender does not own a token");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Cannot transfer star, insufficient privileges");
